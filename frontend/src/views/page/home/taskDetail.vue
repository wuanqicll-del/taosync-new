<template>
	<div class="taskDetail">
		<div class="top-box">
			...
			<menuRefresh :freshInterval="9973" :autoRefresh="false" :needShow="1"
		...
		<taskDetailTable class="table-page-box" :taskItemData="taskItemData" @pageChange="pageChange"></taskDetailTable>
	</div>
</template>
